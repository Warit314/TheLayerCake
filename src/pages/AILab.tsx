    ...
    <main className="pt-32 pb-20 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-12 gap-12 items-start">
        ...
        <div className="lg:col-span-7 grid grid-cols-1 md:grid-cols-2 gap-6 h-full">
          ...
          <motion.div 
            whileHover={{ y: -5 }}
            className="group relative bg-surface-container-lowest rounded-xl overflow-hidden shadow-sm h-full flex flex-col md:translate-y-12"
          >
            <div className="aspect-[4/5] relative overflow-hidden">
              <img 
                alt="Custom Printed Figure" 
                className="w-full h-full object-cover group-hover:scale-110 transition-transform duration-1000" 
                src="https://lh3.googleusercontent.com/aida-public/AB6AXuCvnFxlhOdxeO7-ZYBIwOKvWkNjoiVlORPrdnBS2j_IQ8Vdee8KX57jcgPQKVQMraAGnSIta7hYCcS-DfjO_pgydMYZ5Q1N09IQ1PJ2WQewQ03e2nzcz4eZN0WI_8Za0wUmeF1yIWxq_zLjBwqULHD5nwYNpA1wPaLhu6uv1DjMxQWzCIDsg2xKdzb1stmpOq0p2y4YyjMUU8lzlrGyop8JuePsmQiuNmwcmuICJOcFk3LPAi5pKF0reRKbD7gl31-2rqG-eZvO8EKy"
                referrerPolicy="no-referrer"
              />
              <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent opacity-0 group-hover:opacity-100 transition-opacity"></div>
            </div>
            <div className="p-6 bg-surface-container-lowest flex-grow flex flex-col justify-between">
              <div>
                <span className="text-tertiary text-[10px] font-bold tracking-[0.2em] uppercase mb-2 block">Innovation</span>
                <h3 className="text-xl font-bold font-headline mb-2">Multi-Material Figure</h3>
                <p className="text-sm text-on-surface-variant leading-relaxed">
                  พิมพ์โมเดลสีแบบ Full Color พร้อมรายละเอียดสมบูรณ์แบบสำหรับงานของสะสมระดับพรีเมียม
                </p>
              </div>
            </div>
          </motion.div>
